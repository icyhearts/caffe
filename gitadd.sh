...
git add tools/convert_imageset.fullList.cpp examples/cpp_classification/n2_selfClassificationBatch.cpp keli/src/n3_classificationPipe.cpp examples/mnist/lenet-deploy.prototxt
