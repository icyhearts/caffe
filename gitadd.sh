...
git add tools/convert_imageset.fullList.cpp examples/cpp_classification/n2_selfClassificationBatch.cpp examples/cpp_classification/n3_classificationPipe.cpp
